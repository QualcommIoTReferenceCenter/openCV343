...
modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/samples/tutorial_introduction_to_tracker.cpp.o: /media/sdcard/openCV343/opencv_contrib-3.4/modules/tracking/samples/tutorial_introduction_to_tracker.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/media/sdcard/openCV343/opencv-3.4/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/samples/tutorial_introduction_to_tracker.cpp.o"
	cd /media/sdcard/openCV343/opencv-3.4/build/modules/tracking && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/samples/tutorial_introduction_to_tracker.cpp.o -c /media/sdcard/openCV343/opencv_contrib-3.4/modules/tracking/samples/tutorial_introduction_to_tracker.cpp
...
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_tracking.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_plot.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_video.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_datasets.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_text.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_ml.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_dnn.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_features2d.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_flann.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_highgui.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_videoio.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_imgcodecs.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_imgproc.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: lib/libopencv_core.so.3.4.3
bin/example_tracking_tutorial_introduction_to_tracker: modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/media/sdcard/openCV343/opencv-3.4/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tracking_tutorial_introduction_to_tracker"
	cd /media/sdcard/openCV343/opencv-3.4/build/modules/tracking && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/link.txt --verbose=$(VERBOSE)
...
modules/tracking/CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/clean:
	cd /media/sdcard/openCV343/opencv-3.4/build/modules/tracking && $(CMAKE_COMMAND) -P CMakeFiles/example_tracking_tutorial_introduction_to_tracker.dir/cmake_clean.cmake
